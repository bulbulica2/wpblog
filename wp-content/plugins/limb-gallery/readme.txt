...
The shortcode function of the plugin allows to publish one gallery in multiple ways due to many editable options. Add Limb Gallery button is available both in visual and text tabs of wp editor. The function also gives the opportunity to set the type of layout for gallery and parameters based on the chosen view type. Moreover, the main options for the creation of the lightbox are also in the shortcode function.<br>
