...
class GRSViewShortcode {
	...
	public function display() {
		...
		$viewConf        = $this->model->getViewConf( LIMB_Gallery::$config );
        ...
        <head>
            ...
            <link rel="stylesheet" type="text/css"
                  href="<?php echo GRS_PLG_URL . '/css/grsShortcode.css?ver=' . $version; ?>">
			<?php wp_print_scripts( 'jquery' ); ?>
            <script>
                var task = '<?php echo esc_js( $task ); ?>',
                    data = jQuery.parseJSON('<?=$params?>'),
                    gutenberg = <?=$gutenberg?>,
                    grsBlockId = '<?=esc_js( $grsBlockId )?>',
                    grsAjaxNonce = '<?=esc_js( $grsAjaxNonce )?>',
        ...
        <div class="grsMainCont">
            <div class="grsGallsLightCont">
                    ...
                    <div class="grsGallsButtons">
                        <div>
                            <div class="grsGallButton">
                                <a class="grsGall" href="#">
                                    ...
                                    <span><?php _e( 'Select Gallery', 'limb-gallery' ); ?></span>
                                </a>
                                <!-- GRS titles -->
                            ...
                            <div class="grsAlbButton">
                                <a class="grsAlb" href="#">
                                    <i class="fa fa-camera-retro fa-lg"></i>
                                    <span><?php _e( 'Select Album', 'limb-gallery' ); ?></span>
                                </a>
                                <!-- GRS titles -->
                            ...
                            <div class="grsTypeButton">
                                <a class="grsTypeDeactive" href="#">
                                    <i class="fa fa-camera-retro fa-lg"></i>
                                    <span><?php _e( 'Select view', 'limb-gallery' ); ?></span>
                                </a>
                                <!-- GRS view types -->
                                <div class="grsGallViewsCont" style="display:none">
                                    <div class="grsGallViews">
                                        ...
                                        <div class="grsGallFilmView grsView enabled" grsView="Film"
                                             title="Carousel"></div>
                                        <div class="grsGallCarousel3dView grsView <?php echo $viewConf['carousel3d']['class']; ?>"
                                             grsView="Carousel3d" title="3D Carousel"></div>
                                        <div class="grsGallMosaicView grsView <?php echo $viewConf['views']['class']; ?>"
                                             grsView="Mosaic" title="Mosaic"></div>
                        ...
                        <div class="grsThemeButton">
                            <a class="grsTheme" href="#">
                                <i class="fa fa-camera-retro fa-lg"></i>
                                <span><?php _e( 'Select theme', 'limb-gallery' ); ?></span>
                            </a>
                            <div class="grsThemeNamesCont" style="display:none">
                                <ul class="grsThemeNames">
									<?php foreach ( $grsThemes as $themeKey => $grsTheme ) {
										...
										?>
                                        <li class="grsThemeName <?php echo $default; ?>"
                                            grsthemeid="<?php echo $grsTheme->id; ?>">
                                            <span class="grsCheck"></span>
                        ...
                        <div class="grsThumbnail">
                            <div class="grsThumbnailTitleCont">
                                <div class="grsThumbnailTitle">
									<?php _e( 'Thumbnail view', 'limb-gallery' ); ?>
                                </div>
                                <div class="grsClear"></div>
                            </div>
                            <div class="grsThumbnailParamsCont">
                                <div class="grsThumbnailParams">
                                    <div class="grsRow">
                                        <div class="grsCell">
                                            <label for="thumbnailWidth"><?php _e( 'Width:', 'limb-gallery' ); ?></label>
                                        </div>
                                        <div class="grsCell">
                                            <input type="number" value="200" name="thumbnailWidth"
                                                   id="thumbnailWidth"><span>px</span>
                                        </div>
                                        <div class="grsCell">
                                            <label for="thumbnailHeight"><?php _e( 'Height:',
													'limb-gallery' ); ?></label>
                                        </div>
                                        <div class="grsCell">
                                            <input type="number" value="160" name="thumbnailHeight"
                                                   id="thumbnailHeight"><span>px</span>
                                        </div>
                                    </div>
                                    <div class="grsRow">
                                        <div class="grsCell grsMasonryContWidthLab" style="width:25%">
                                            <label for="thumbnailContWidth"><?php _e( 'Container Width:',
													'limb-gallery' ); ?></label>
                                        </div>
                                        <div class="grsCell grsMasonryContWidthInp" style="width:25%">
                                            <input type="number" value="100" name="thumbnailContWidth" max="100" min="0"
                                                   id="thumbnailContWidth"><span>%</span>
                                        </div>
                                        <div class="grsCell">
                                            <label for="thumbnailTitle"><?php _e( 'Show title:',
													'limb-gallery' ); ?></label>
                                        </div>
                                        <div class="grsCell">
                                            <select name="thumbnailTitle" id="thumbnailTitle">
                                                <option value="no"><?php _e( 'No', 'limb-gallery' ); ?></option>
                                                <option selected
                                                        value="onhover"><?php _e( 'On hover',
														'limb-gallery' ); ?></option>
                                                <option value="always"><?php _e( 'Always', 'limb-gallery' ); ?></option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="grsRow">
                                        <div class="grsCell">
                                            <label for="thumbnailPolaroid_1"><?php _e( 'Polaroid:',
													'limb-gallery' ); ?></label>
                                        </div>
                                        <div class="grsCell">
                                            <label for="thumbnailPolaroid_1"><?php _e( 'Yes:',
													'limb-gallery' ); ?></label>
                                            <input type="radio" value="1" name="thumbnailPolaroid"
                                                   id="thumbnailPolaroid_1">
                                            <label for="thumbnailPolaroid_0"><?php _e( 'No:',
													'limb-gallery' ); ?></label>
                                    ...
                                    <div class="grsRow">
                                        <div class="grsCell">
                                            <label for="thumbnailImagesPerpage"><?php _e( 'Items Perpage:',
													'limb-gallery' ); ?></label>
                                        </div>
                                        <div class="grsCell">
                                        ...
                                        <div class="grsCell">
                                            <label for="thumbnailPagination"><?php _e( 'Pagination:',
													'limb-gallery' ); ?></label>
                                        </div>
                                        <div class="grsCell">
                                            <select name="thumbnailPagination" id="thumbnailPagination">
                                                <option value="numbers"><?php _e( 'Numbers',
														'limb-gallery' ); ?></option>
                                                <option selected
                                                        value="loadMore"><?php _e( 'Load more',
														'limb-gallery' ); ?></option>
                                                <option value="scrolling"><?php _e( 'Scrolling',
														'limb-gallery' ); ?></option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="grsRow">
                                        <div class="grsCell">
                                            <label for="thumbnailOrderBy"><?php _e( 'Order by:',
													'limb-gallery' ); ?></label>
                                        </div>
                                        <div class="grsCell">
                                        ...
                                        <div class="grsCell">
                                            <label for="thumbnailOrdering"><?php _e( 'Ordering:',
													'limb-gallery' ); ?></label>
                                        </div>
                                        <div class="grsCell">
                                            <select name="thumbnailOrdering" id="thumbnailOrdering">
                                                <option selected
                                                        value="ASC"><?php _e( 'ASC', 'limb-gallery' ); ?></option>
                                                <option value="DESC"><?php _e( 'DESC', 'limb-gallery' ); ?></option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="grsRow">
                                        <div class="grsCell">
                                            <label for="thumbnailClickAction"><?php _e( 'Click action:',
													'limb-gallery' ); ?></label>
                                        </div>
                                        <div class="grsCell">
                                        ...
                                        <div class="grsCell">
                                            <label for="thumbnailOpenLinkTarget" id="thumbnailOpenLinkTargetLabel"
                                                   style="display:none"><?php _e( 'Link target:',
													'limb-gallery' ); ?></label>
                                        </div>
                                        <div class="grsCell">
                        ...
                        <div class="grsFilm">
                            <div class="grsFilmTitleCont">
                                <div class="grsFilmTitle">
									<?php _e( 'Carousel view', 'limb-gallery' ); ?>
                                </div>
                                <div class="grsClear">
                            ...
                            <div class="grsFilmParamsCont">
                                <div class="grsFilmParams">
                                    <div class="grsRow">
                                        <div class="grsCell">
                                            <label for="fmWidth"><?php _e( 'Width:', 'limb-gallery' ); ?></label>
                                        </div>
                                        <div class="grsCell">
                                            <input type="number" value="200" name="fmWidth" id="fmWidth"><span>px</span>
                                        </div>
                                        <div class="grsCell">
                                            <label for="fmHeight"><?php _e( 'Height:', 'limb-gallery' ); ?></label>
                                        </div>
                                        <div class="grsCell">
                                            <input type="number" value="160" name="fmHeight"
                                                   id="fmHeight"><span>px</span>
                                        </div>
                                    </div>
                                    <div class="grsRow">
                                        <div class="grsCell grsMasonryContWidthLab" style="width:25%">
                                            <label for="fmContWidth"><?php _e( 'Container Width:',
													'limb-gallery' ); ?></label>
                                        </div>
                                        <div class="grsCell grsMasonryContWidthInp" style="width:25%">
                                            <input type="number" value="100" name="fmContWidth" max="100" min="0"
                                                   id="fmContWidth"><span>%</span>
                                        </div>
                                        <div class="grsCell">
                                            <label for="fmTitle"><?php _e( 'Show title:', 'limb-gallery' ); ?></label>
                                        </div>
                                        <div class="grsCell">
                                    ...
                                    <div class="grsRow">
                                        <div class="grsCell">
                                            <label for="fmImagesPerpage"><?php _e( 'Items Perpage:',
													'limb-gallery' ); ?></label>
                                        </div>
                                        <div class="grsCell">
                                        ...
                                        <div class="grsCell">
                                            <label for="fmNav"><?php _e( 'Navigation:', 'limb-gallery' ); ?></label>
                                        </div>
                                        <div class="grsCell">
                                            <select name="fmNav" id="fmNav">
                                                <option selected
                                                        value="buttons"><?php _e( 'Buttons',
														'limb-gallery' ); ?></option>
                                                <option value="scroll"><?php _e( 'Scrolling',
														'limb-gallery' ); ?></option>
                                                <option value="both"><?php _e( 'Buttons and scrolling',
														'limb-gallery' ); ?></option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="grsRow">
                                        <div class="grsCell">
                                            <label for="fmOrderBy"><?php _e( 'Order by:', 'limb-gallery' ); ?></label>
                                        </div>
                                        <div class="grsCell">
                                        ...
                                        <div class="grsCell">
                                            <label for="fmOrdering"><?php _e( 'Ordering:', 'limb-gallery' ); ?></label>
                                        </div>
                                        <div class="grsCell">
                                    ...
                                    <div class="grsRow">
                                        <div class="grsCell">
                                            <label for="fmClickAction"><?php _e( 'Click action:',
													'limb-gallery' ); ?></label>
                                        </div>
                                        <div class="grsCell">
                        ...
                        <div class="grsCarousel3d">
                            <div class="grsCarousel3dTitleCont">
                                <div class="grsCarousel3dTitle">
									<?php _e( '3D Carousel view', 'limb-gallery' ); ?>
                                </div>
                                <div class="grsClear">
                            ...
                            <div class="grsCarousel3dParamsCont">
                                <div class="grsCarousel3dParams">
                                    <div class="grsRow">
                                        <div class="grsCell">
                                            <label for="crs3dWidth"><?php _e( 'Width:', 'limb-gallery' ); ?></label>
                                        </div>
                                        <div class="grsCell">
                                            <input type="number" value="200" name="crs3dWidth"
                                                   id="crs3dWidth"><span>px</span>
                                        </div>
                                        <div class="grsCell">
                                            <label for="crs3dHeight"><?php _e( 'Height:', 'limb-gallery' ); ?></label>
                                        </div>
                                        <div class="grsCell">
                                            <input type="number" value="160" name="crs3dHeight" id="crs3dHeight"><span>px</span>
                                        </div>
                                    </div>
                                    <div class="grsRow">
                                        <div class="grsCell grsMasonryContWidthLab" style="width:25%">
                                            <label for="crs3dContWidth"><?php _e( 'Container Width:',
													'limb-gallery' ); ?></label>
                                        </div>
                                        <div class="grsCell grsMasonryContWidthInp" style="width:25%">
                                            <input type="number" value="100" name="crs3dContWidth" max="100" min="0"
                                                   id="crs3dContWidth"><span>%</span>
                                        </div>
                                    </div>
                                    <div class="grsRow">
                                        <div class="grsCell grsMasonryContWidthLab" style="width:25%">
                                            <label for="crs3dLDepth"><?php _e( 'Left Side Depth:',
													'limb-gallery' ); ?></label>
                                        </div>
                                        <div class="grsCell grsMasonryContWidthInp" style="width:25%">
                                        ...
                                        <div class="grsCell grsMasonryContWidthLab" style="width:25%">
                                            <label for="crs3dRDepth"><?php _e( 'Right Side Depth:',
													'limb-gallery' ); ?></label>
                                        </div>
                                        <div class="grsCell grsMasonryContWidthInp" style="width:25%">
                                    ...
                                    <div class="grsRow">
                                        <div class="grsCell grsMasonryContWidthLab" style="width:25%">
                                            <label for="crs3dMaxScale"><?php _e( 'Image Maximum Scale:',
													'limb-gallery' ); ?></label>
                                        </div>
                                        <div class="grsCell grsMasonryContWidthInp" style="width:25%">
                                        ...
                                        <div class="grsCell grsMasonryContWidthLab" style="width:25%">
                                            <label for="crs3dMinScale"><?php _e( 'Image Minimum Scale:',
													'limb-gallery' ); ?></label>
                                        </div>
                                        <div class="grsCell grsMasonryContWidthInp" style="width:25%">
                                    ...
                                    <div class="grsRow">
                                        <div class="grsCell">
                                            <label for="crs3dImagesPerpage"><?php _e( 'Items Perpage:',
													'limb-gallery' ); ?></label>
                                        </div>
                                        <div class="grsCell">
                                        ...
                                        <div class="grsCell">
                                            <label for="crs3dViewItemsCount"><?php _e( 'View Images Count:',
													'limb-gallery' ); ?></label>
                                        </div>
                                        <div class="grsCell">
                                    ...
                                    <div class="grsRow">
                                        <div class="grsCell">
                                            <label for="crs3dTitle"><?php _e( 'Show title:',
													'limb-gallery' ); ?></label>
                                        </div>
                                        <div class="grsCell">
                                    ...
                                    <div class="grsRow">
                                        <div class="grsCell">
                                            <label for="crs3dOrderBy"><?php _e( 'Order by:',
													'limb-gallery' ); ?></label>
                                        </div>
                                        <div class="grsCell">
                                        ...
                                        <div class="grsCell">
                                            <label for="crs3dOrdering"><?php _e( 'Ordering:',
													'limb-gallery' ); ?></label>
                                        </div>
                                        <div class="grsCell">
                                    ...
                                    <div class="grsRow">
                                        <div class="grsCell">
                                            <label for="crs3dClickAction"><?php _e( 'Click action:',
													'limb-gallery' ); ?></label>
                                        </div>
                                        <div class="grsCell">
                        ...
                        <div class="grsMasonry">
                            <div class="grsMasonryTitleCont">
                                <div class="grsMasonryTitle">
									<?php _e( 'Masonry view', 'limb-gallery' ); ?>
                                </div>
                                <div class="grsClear">
                            ...
                            <div class="grsMasonryParamsCont">
                                <div class="grsMasonryParams">
                                    <div class="grsRow">
                                        <div class="grsCell">
                                            <label for="masonryType"><?php _e( 'Type:', 'limb-gallery' ); ?></label>
                                        </div>
                                        <div class="grsCell">
                                            <label for="masonryType_ver"><?php _e( 'Vertical:',
													'limb-gallery' ); ?></label>
                                            <input type="radio" checked value="ver" name="masonryType"
                                                   id="masonryType_ver">
                                            <label for="masonryType_hor"><?php _e( 'Horizontal:',
													'limb-gallery' ); ?></label>
                                    ...
                                    <div class="grsRow">
                                        <div class="grsCell">
                                            <label for="masonryImagesPerpage"><?php _e( 'Items Perpage:',
													'limb-gallery' ); ?></label>
                                        </div>
                                        <div class="grsCell">
                                        ...
                                        <div class="grsCell">
                                            <label for="masonryPagination"><?php _e( 'Pagination:',
													'limb-gallery' ); ?></label>
                                        </div>
                                        <div class="grsCell">
                                    ...
                                    <div class="grsRow">
                                        <div class="grsCell">
                                            <label for="masonryOrderBy"><?php _e( 'Order by:',
													'limb-gallery' ); ?></label>
                                        </div>
                                        <div class="grsCell">
                                        ...
                                        <div class="grsCell">
                                            <label for="masonryOrdering"><?php _e( 'Ordering:',
													'limb-gallery' ); ?></label>
                                        </div>
                                        <div class="grsCell">
                                    ...
                                    <div class="grsRow">
                                        <div class="grsCell">
                                            <label for="masonryClickAction"><?php _e( 'Click action:',
													'limb-gallery' ); ?></label>
                                        </div>
                                        <div class="grsCell">
                        ...
                        <div class="grsMosaic">
                            <div class="grsMosaicTitleCont">
                                <div class="grsMosaicTitle">
									<?php _e( 'Mosaic view', 'limb-gallery' ); ?>
                                </div>
                                <div class="grsClear">
                            ...
                            <div class="grsMosaicParamsCont">
                                <div class="grsMosaicParams">
                                    <div class="grsRow">
                                        <div class="grsCell">
                                            <label for="mosaicType"><?php _e( 'Type:', 'limb-gallery' ); ?></label>
                                        </div>
                                        <div class="grsCell">
                                            <label for="mosaicType_ver"><?php _e( 'Vertical:',
													'limb-gallery' ); ?></label>
                                            <input type="radio" checked value="ver" name="mosaicType"
                                                   id="mosaicType_ver">
                                            <label for="mosaicType_hor"><?php _e( 'Horizontal:',
													'limb-gallery' ); ?></label>
                                    ...
                                    <div class="grsRow">
                                        <div class="grsCell grsMosaicVerLab grsMosaicRandLab">
                                            <label for="mosaicWidth"><?php _e( 'Width:', 'limb-gallery' ); ?></label>
                                        </div>
                                        ...
                                        <div class="grsCell grsMosaicHorLab" style="display:none;width:25%">
                                            <label for="mosaicHeight"><?php _e( 'Height:', 'limb-gallery' ); ?></label>
                                        </div>
                                    ...
                                    <div class="grsRow">
                                        <div class="grsCell">
                                            <label for="mosaicImagesPerpage"><?php _e( 'Items Perpage:',
													'limb-gallery' ); ?></label>
                                        </div>
                                        <div class="grsCell">
                                        ...
                                        <div class="grsCell">
                                            <label for="mosaicPagination"><?php _e( 'Pagination:',
													'limb-gallery' ); ?></label>
                                        </div>
                                        <div class="grsCell">
                                    ...
                                    <div class="grsRow">
                                        <div class="grsCell">
                                            <label for="mosaicOrderBy"><?php _e( 'Order by:',
													'limb-gallery' ); ?></label>
                                        </div>
                                        <div class="grsCell">
                                        ...
                                        <div class="grsCell">
                                            <label for="mosaicOrdering"><?php _e( 'Ordering:',
													'limb-gallery' ); ?></label>
                                        </div>
                                        <div class="grsCell">
                                    ...
                                    <div class="grsRow">
                                        <div class="grsCell">
                                            <label for="mosaicClickAction"><?php _e( 'Click action:',
													'limb-gallery' ); ?></label>
                                        </div>
                                        <div class="grsCell">
                        ...
                        <div class="grsAlbum">
                            <div class="grsAlbumTitleCont">
                                <div class="grsAlbumTitle">
									<?php _e( 'Album view', 'limb-gallery' ); ?>
                                </div>
                                <div class="grsClear"></div>
                            </div>
                            <div class="grsAlbumParamsCont">
                                <div class="grsAlbumParams">
                                    <div class="grsRow">
                                        <div class="grsCell">
                                            <label for="albMainView"><?php _e( 'Main view type:',
													'limb-gallery' ); ?></label>
                                        </div>
                                        <div class="grsCell">
                                            <select name="albMainView" id="albMainView">
                                                <option value="Thumbnail"><?php _e( 'Thumbnail',
														'limb-gallery' ); ?></option>
                                                <option value="Masonry"><?php _e( 'Masonry',
														'limb-gallery' ); ?></option>
                                                <option <?php echo $viewConf['views']['mode']; ?>
                                                        value="Mosaic"><?php _e( 'Mosaic', 'limb-gallery' ); ?></option>
                                            </select>
                                        </div>
                                        <div class="grsCell grsAlbMasMosTypeLab">
                                            <label for="albMasMosType_ver"><?php _e( 'Type:',
													'limb-gallery' ); ?></label>
                                        </div>
                                        <div class="grsCell grsAlbMasMosTypeInp">
                                            <label for="albMasMosType_ver"><?php _e( 'Vertical:',
													'limb-gallery' ); ?></label>
                                            <input type="radio" checked value="ver" name="albMasMosType"
                                                   id="albMasMosType_ver">
                                            <label for="albMasMosType_hor"><?php _e( 'Horizontal:',
													'limb-gallery' ); ?></label>
                                    ...
                                    <div class="grsRow">
                                        <div class="grsCell grsAlbVerLab">
                                            <label for="albWidth"><?php _e( 'Width:', 'limb-gallery' ); ?></label>
                                        </div>
                                        <div class="grsCell grsAlbVerInp">
                                            <input type="number" value="200" name="albWidth"
                                                   id="albWidth"><span>px</span>
                                        </div>
                                        <div class="grsCell grsAlbHorLab">
                                            <label for="albHeight"><?php _e( 'Height:', 'limb-gallery' ); ?></label>
                                        </div>
                                        <div class="grsCell grsAlbHorInp">
                                            <input type="number" value="160" name="albHeight"
                                                   id="albHeight"><span>px</span>
                                        </div>
                                    </div>
                                    <div class="grsRow">
                                        <div class="grsCell grsMosaicContWidthLab">
                                            <label for="albContWidthLab"><?php _e( 'Main container Width:',
													'limb-gallery' ); ?></label>
                                        </div>
                                        <div class="grsCell albContWidthInp">
                                            <input type="number" value="60" name="albContWidth" max="100" min="0"
                                                   id="albContWidth"><span>%</span>
                                        </div>
                                        <div class="grsCell">
                                            <label for="albTitle"><?php _e( 'Show title:', 'limb-gallery' ); ?></label>
                                        </div>
                                        <div class="grsCell">
                                            <select name="albTitle" id="albTitle">
                                                <option value="no"><?php _e( 'No', 'limb-gallery' ); ?></option>
                                                <option value="onhover"><?php _e( 'On hover',
														'limb-gallery' ); ?></option>
                                                <option selected
                                                        value="always"><?php _e( 'Always', 'limb-gallery' ); ?></option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="grsRow">
                                        <div class="grsCell">
                                            <label for="albOrderBy"><?php _e( 'Order by:', 'limb-gallery' ); ?></label>
                                        </div>
                                        <div class="grsCell">
                                        ...
                                        <div class="grsCell">
                                            <label for="albOrdering"><?php _e( 'Ordering:', 'limb-gallery' ); ?></label>
                                        </div>
                                        <div class="grsCell">
                                    ...
                                    <div class="grsRow">
                                        <div class="grsCell">
                                            <label for="albGalView"><?php _e( 'Gallery view type:',
													'limb-gallery' ); ?></label>
                                        </div>
                                        <div class="grsCell">
                                        ...
                                        <div class="grsCell grsAlbGalMasMosTypeLab">
                                            <label for="albGalMasMosType_ver"><?php _e( 'Type:',
													'limb-gallery' ); ?></label>
                                        </div>
                                        <div class="grsCell grsAlbGalMasMosTypeInp">
                                            <label for="albGalMasMosType_ver"><?php _e( 'Vertical:',
													'limb-gallery' ); ?></label>
                                            <input type="radio" checked value="ver" name="albGalMasMosType"
                                                   id="albGalMasMosType_ver">
                                            <label for="albGalMasMosType_hor"><?php _e( 'Horizontal:',
													'limb-gallery' ); ?></label>
                                    ...
                                    <div class="grsRow">
                                        <div class="grsCell grsAlbGalVerLab">
                                            <label for="albGalWidth"><?php _e( 'Width:', 'limb-gallery' ); ?></label>
                                        </div>
                                        <div class="grsCell grsAlbGalVerLab">
                                            <input type="number" value="200" name="albGalWidth" id="albGalWidth"><span>px</span>
                                        </div>
                                        <div class="grsCell grsAlbGalHorLab">
                                            <label for="albGalHeight"><?php _e( 'Height:', 'limb-gallery' ); ?></label>
                                        </div>
                                        <div class="grsCell grsAlbGalHorInp">
                                            <input type="number" value="160" name="albGalHeight"
                                                   id="albGalHeight"><span>px</span>
                                        </div>
                                    </div>
                                    <div class="grsRow">
                                        <div class="grsCell grsMosaicContWidthLab">
                                            <label for="galContWidthLab"><?php _e( 'Gallery container Width:',
													'limb-gallery' ); ?></label>
                                        </div>
                                        <div class="grsCell albContWidthInp">
                                            <input type="number" value="100" name="galContWidth" max="100" min="0"
                                                   id="galContWidth"><span>%</span>
                                        </div>
                                        <div class="grsCell">
                                            <label for="galTitle"><?php _e( 'Show title:', 'limb-gallery' ); ?></label>
                                        </div>
                                        <div class="grsCell">
                                    ...
                                    <div class="grsRow">
                                        <div class="grsCell">
                                            <label for="galOrderBy"><?php _e( 'Order by:', 'limb-gallery' ); ?></label>
                                        </div>
                                        <div class="grsCell">
                                        ...
                                        <div class="grsCell">
                                            <label for="galOrdering"><?php _e( 'Ordering:', 'limb-gallery' ); ?></label>
                                        </div>
                                        <div class="grsCell">
                                    ...
                                    <div class="grsRow">
                                        <div class="grsCell">
                                            <label for="albPagination"><?php _e( 'Pagination:',
													'limb-gallery' ); ?></label>
                                        </div>
                                        <div class="grsCell">
                                            <select name="albPagination" id="albPagination">
                                                <option value="numbers"><?php _e( 'Numbers',
														'limb-gallery' ); ?></option>
                                                <option value="loadMore"><?php _e( 'Load more',
														'limb-gallery' ); ?></option>
                                                <option value="scrolling"><?php _e( 'Scrolling',
														'limb-gallery' ); ?></option>
                                            </select>
                                        ...
                                        <div class="grsCell">
                                            <label for="albPerpage"><?php _e( 'Items Perpage:',
													'limb-gallery' ); ?></label>
                                        </div>
                                        <div class="grsCell">
                                    ...
                                    <div class="grsRow">
                                        <div class="grsCell">
                                            <label for="galClickAction"><?php _e( 'Click action:',
													'limb-gallery' ); ?></label>
                                        </div>
                                        <div class="grsCell">
                ...
                <div class="grsLightCont">
                    <div class="grsLightButtons">
                        <div class="grsLightboxButton">
                            <a class="grsLightboxDeactive" href="#">
                                <i class="fa fa-camera-retro fa-lg"></i>
                                <span><?php _e( 'Lightbox', 'limb-gallery' ); ?></span>
                            </a>
                        </div>
                        <div class="grsClear"></div>
                    </div>
                    <div class="grsLightboxParamsCont" style="display:none">
                        <div class="grsLightboxParams">
                            <div class="grsRow">
                                <div class="grsCell">
                                    <label for="lightboxFullW"><?php _e( 'Full width:', 'limb-gallery' ); ?></label>
                                </div>
                                <div class="grsCell">
                                    <div class="grsForSizeing">
                                        <label for="lightboxFullW_1"><?php _e( 'Yes:', 'limb-gallery' ); ?></label>
                                        <input type="radio" checked value="1" name="lightboxFullW" id="lightboxFullW_1">
                                        <label for="lightboxFullW_0"><?php _e( 'No:', 'limb-gallery' ); ?></label>
                            ...
                            <div class="grsRow">
                                <div class="grsCell grsLightboxWidthLab" style="display: none">
                                    <label for="lightboxWidth"><?php _e( 'Width:', 'limb-gallery' ); ?></label>
                                </div>
                                <div class="grsCell grsLightboxWidthInp" style="display: none">
                                    <input type="number" value="800" name="lightboxWidth"
                                           id="lightboxWidth"><span>px</span>
                                </div>
                                <div class="grsCell grsLightboxHeightLab" style="display: none">
                                    <label for="lightboxHeight"><?php _e( 'Height:', 'limb-gallery' ); ?></label>
                                </div>
                                <div class="grsCell grsLightboxHeightInp" style="display: none">
                                    <input type="number" value="600" name="lightboxHeight"
                                           id="lightboxHeight"><span>px</span>
                                </div>
                            </div>
                            <div class="grsRow">
                                <div class="grsCell <?php echo $viewConf['filmstrip']['class']; ?>">
                                    <label for="lightboxFilmstrip"><?php _e( 'Filmstrip:', 'limb-gallery' ); ?></label>
                                </div>
                                <div class="grsCell <?php echo $viewConf['filmstrip']['class']; ?>">
                                    <label for="lightboxFilmstrip_1"><?php _e( 'Yes:', 'limb-gallery' ); ?></label>
                                    <input type="radio" <?php echo $viewConf['filmstrip']['checked_yes'] . ' ' . $viewConf['filmstrip']['mode']; ?>
                                           value="1" name="lightboxFilmstrip" id="lightboxFilmstrip_1">
                                    <label for="lightboxFilmstrip_0"><?php _e( 'No:', 'limb-gallery' ); ?></label>
                                    <input type="radio" <?php echo $viewConf['filmstrip']['checked_no'] . ' ' . $viewConf['filmstrip']['mode']; ?>
                                           value="0" name="lightboxFilmstrip" id="lightboxFilmstrip_0">
                                </div>
                                <div class="grsCell <?php echo $viewConf['comments']['class']; ?>">
                                    <label for="lightboxComment"><?php _e( 'Comments:', 'limb-gallery' ); ?></label>
                                </div>
                                <div class="grsCell <?php echo $viewConf['comments']['class']; ?>">
                                    <label for="lightboxComment_1"><?php _e( 'Yes:', 'limb-gallery' ); ?></label>
                                    <input type="radio" <?php echo $viewConf['comments']['checked_yes'] . ' ' . $viewConf['comments']['mode']; ?>
                                           value="1" name="lightboxComment" id="lightboxComment_1">
                                    <label for="lightboxComment_0"><?php _e( 'No:', 'limb-gallery' ); ?></label>
                                    <input type="radio" <?php echo $viewConf['comments']['checked_no'] . ' ' . $viewConf['comments']['mode']; ?>
                                           value="0" name="lightboxComment" id="lightboxComment_0">
                                </div>
                            </div>
                            <div class="grsRow">
                                <div class="grsCell">
                                    <label for="lightboxContButts_1"><?php _e( 'Control buttons:',
											'limb-gallery' ); ?></label>
                                </div>
                                <div class="grsCell">
                                    <label for="lightboxContButts_1"><?php _e( 'Yes:', 'limb-gallery' ); ?></label>
                                    <input type="radio" checked value="1" name="lightboxContButts"
                                           id="lightboxContButts_1">
                                    <label for="lightboxContButts_0"><?php _e( 'No:', 'limb-gallery' ); ?></label>
                                    <input type="radio" value="0" name="lightboxContButts" id="lightboxContButts_0">
                                </div>
                                <div class="grsCell">
                                    <label for="lightboxEffect"><?php _e( 'Effect:', 'limb-gallery' ); ?></label>
                                </div>
                                <div class="grsCell">
                                    <select name="lightboxEffect" id="lightboxEffect">
                                        <optgroup label="<?php _e( 'No effect' ); ?>">
                                            <option value="no"><?php _e( 'No', 'limb-gallery' ); ?></option>
                                        </optgroup>
                                        <optgroup label="<?php _e( 'No cutting' ); ?>">
                                            <option selected
                                                    value="fade"><?php _e( 'Fade', 'limb-gallery' ); ?></option>
                                            <option <?php echo $viewConf['effects']['mode']; ?>
                                                    value="slideInLeft"><?php _e( 'Slide In left',
													'limb-gallery' ); ?></option>
                                            <option <?php echo $viewConf['effects']['mode']; ?>
                                                    value="slideInDown"><?php _e( 'Slide In Down',
													'limb-gallery' ); ?></option>
                                            <option <?php echo $viewConf['effects']['mode']; ?>
                                                    value="flip"><?php _e( 'Flip & Zoom', 'limb-gallery' ); ?></option>
                                            <option <?php echo $viewConf['effects']['mode']; ?>
                                                    value="zoomIn"><?php _e( 'Zoom In', 'limb-gallery' ); ?></option>
                                            <option <?php echo $viewConf['effects']['mode']; ?>
                                                    value="zoomInLeft"><?php _e( 'Zoom In Left',
													'limb-gallery' ); ?></option>
                                            <option <?php echo $viewConf['effects']['mode']; ?>
                                                    value="zoomInDown"><?php _e( 'Zoom In Down',
													'limb-gallery' ); ?></option>
                                        </optgroup>
                                        <optgroup label="<?php _e( 'Cutting vertical' ); ?>">
                                            <option <?php echo $viewConf['effects']['mode']; ?>
                                                    value="zoomX"><?php _e( 'Zoom', 'limb-gallery' ); ?></option>
                                            <option <?php echo $viewConf['effects']['mode']; ?>
                                                    value="flipX"><?php _e( 'Flip', 'limb-gallery' ); ?></option>
                                            <option <?php echo $viewConf['effects']['mode']; ?>
                                                    value="rotateX"><?php _e( 'Rotate', 'limb-gallery' ); ?></option>
                                            <option <?php echo $viewConf['effects']['mode']; ?>
                                                    value="fadeX"><?php _e( 'Fade out up', 'limb-gallery' ); ?></option>
                                        </optgroup>
                                        <optgroup label="<?php _e( 'Cutting horizontal' ); ?>">
                                            <option <?php echo $viewConf['effects']['mode']; ?>
                                                    value="zoomY"><?php _e( 'Zoom', 'limb-gallery' ); ?></option>
                                            <option <?php echo $viewConf['effects']['mode']; ?>
                                                    value="flipY"><?php _e( 'Flip', 'limb-gallery' ); ?></option>
                                            <option <?php echo $viewConf['effects']['mode']; ?>
                                                    value="rotateY"><?php _e( 'Rotate', 'limb-gallery' ); ?></option>
                                            <option <?php echo $viewConf['effects']['mode']; ?>
                                                    value="fadeY"><?php _e( 'Fade out right',
													'limb-gallery' ); ?></option>
                                        </optgroup>
                                        <optgroup label="<?php _e( 'Mix cutting out' ); ?>">
                                            <option <?php echo $viewConf['effects']['mode']; ?>
                                                    value="fadeXYFun"><?php _e( 'Fade (Fun)',
													'limb-gallery' ); ?></option>
                                            <option <?php echo $viewConf['effects']['mode']; ?>
                                                    value="rollXY"><?php _e( 'Roll', 'limb-gallery' ); ?></option>
                                            <option <?php echo $viewConf['effects']['mode']; ?>
                                                    value="zoomXY"><?php _e( 'Zoom', 'limb-gallery' ); ?></option>
                                            <option <?php echo $viewConf['effects']['mode']; ?>
                                                    value="rotateXY"><?php _e( 'Rotate', 'limb-gallery' ); ?></option>
                                            <option <?php echo $viewConf['effects']['mode']; ?>
                                                    value="zoomLeftXY"><?php _e( 'Zoom out Left',
													'limb-gallery' ); ?></option>
                                            <option <?php echo $viewConf['effects']['mode']; ?>
                                                    value="zoomXYFun"><?php _e( 'Zoom (Fun)',
													'limb-gallery' ); ?></option>
                                            <option <?php echo $viewConf['effects']['mode']; ?>
                                                    value="zoomXYDownFun"><?php _e( 'Zoom Down (Fun)',
													'limb-gallery' ); ?></option>
                                        </optgroup>
                                        <optgroup label="<?php _e( 'Mix cutting in' ); ?>">
                                            <option <?php echo $viewConf['effects']['mode']; ?>
                                                    value="zoomXYInFun"><?php _e( 'Zoom', 'limb-gallery' ); ?></option>
                                            <option <?php echo $viewConf['effects']['mode']; ?>
                                                    value="zoomXYInUpFun"><?php _e( 'Zoom Up',
													'limb-gallery' ); ?></option>
                                            <option <?php echo $viewConf['effects']['mode']; ?>
                                                    value="fadeXYInFun"><?php _e( 'Fade (Fun)',
													'limb-gallery' ); ?></option>
                                        </optgroup>
                                        <optgroup label="<?php _e( 'Random' ); ?>">
                                            <option <?php echo $viewConf['effects']['mode']; ?>
                                                    value="random"><?php _e( 'Random', 'limb-gallery' ); ?></option>
                                        </optgroup>
                                    </select>
                                </div>
                            </div>
                            <div class="grsRow">
                                <div class="grsCell grsLightboxFButtLab">
                                    <label for="lightboxFButt_1"><?php _e( 'Facebook:', 'limb-gallery' ); ?></label>
                                </div>
                                <div class="grsCell grsLightboxFButtInp">
                                    <label for="lightboxFButt_1"><?php _e( 'Yes:', 'limb-gallery' ); ?></label>
                                    <input type="radio" checked value="1" name="lightboxFButt" id="lightboxFButt_1">
                                    <label for="lightboxFButt_0"><?php _e( 'No:', 'limb-gallery' ); ?></label>
                            ...
                            <div class="grsRow">
                                <div class="grsCell">
                                    <label for="lightboxImCn_1"><?php _e( 'Image counting', 'limb-gallery' ); ?>
                                        :</label>
                                </div>
                                <div class="grsCell">
                                    <label for="lightboxImCn_1"><?php _e( 'Yes:', 'limb-gallery' ); ?></label>
                                    <input type="radio" checked value="1" name="lightboxImCn" id="lightboxImCn_1">
                                    <label for="lightboxImCn_0"><?php _e( 'No:', 'limb-gallery' ); ?></label>
                                    <input type="radio" value="0" name="lightboxImCn" id="lightboxImCn_0">
                                </div>
                                <div class="grsCell">
                                    <label for="lightboxSwipe"><?php _e( 'Swipe:', 'limb-gallery' ); ?></label>
                                </div>
                                <div class="grsCell">
                                    <label for="lightboxSwipe_1"><?php _e( 'Yes:', 'limb-gallery' ); ?></label>
                                    <input type="radio" checked value="1" name="lightboxSwipe" id="lightboxSwipe_1">
                                    <label for="lightboxSwipe_0"><?php _e( 'No:', 'limb-gallery' ); ?></label>
                ...
                <div class="grsOkCont">
                    <div class="grsOk">
						<?php echo $task == 'update' ? __( 'Update', 'limb-gallery' ) : __( 'Insert',
							'limb-gallery' ); ?>
                    </div>
                    <div class="grsClear"></div>
                </div>
